...
static const McpToolCategory kMcpToolCategories[] =
{
    ...
    {"breakpoints", "Breakpoints", "Set, clear, and list CPU execution/read/write/range breakpoints for HuCard and CD address spaces."},
...
static const char* const kMcpMemoryTools[] =
{
    ...
    "reset_access_map", "dump_access_map"
};

static const char* const kMcpCpuTools[] =
{
    "get_huc6280_status", "write_huc6280_register"
};
...
{
    "get_huc6270_registers", "write_huc6270_register", "get_huc6270_status", "get_huc6260_status",
    "get_huc6202_status"
};
